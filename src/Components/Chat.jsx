                ...
                <div className="   ">
                    <div className="mx-40 bg-gra y-200 p- bg-slate-100 rounded-2xl mt-3 mb-8 shadow-2xl"> {/* Add mx-auto to center horizontally */}
                        <div className="flex-1 p:2 sm:p-6 justify-between flex flex-col h-[92vh] container mx-auto">
                            ...
                            <div
                                id="messages"
                                className="shadow-inner flex flex-col space-y-4 p-3 overflow-y-auto scrollbar-thumb-blue scrollbar-thumb-rounded scrollbar-track-blue-lighter scrollbar-w-2 scrolling-touch"
                            >
                                ...
                                <div className="chat-message">
                                    <div className="flex items-end justify-end">
                                        ...
                                        <img
                                            src={userlogo}
                                            alt="My profile"
                                            className="w-9 h-9 rounded-full order-2"
                                        />
                                    </div>
                                </div>
                                <div className="chat-message">
